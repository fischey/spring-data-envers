...
public class QueryDslWithEnversRevisionRepository<T, ID extends Serializable, N extends Number & Comparable<N>>
	...
	@Override
	public RevisionWithRevisionType findLastChangeRevisionSince(final ID id, final Date since) {
		return delegateRepository.findLastChangeRevisionSince(id, since);
	}
